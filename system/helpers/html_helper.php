...
*/
  function generate_html5_head($title,$css=FALSE,$description=FALSE,$keywords=FALSE,$viewport=FALSE,$noindex=FALSE){
    ...
    $html5 .= header_link('//cdn.fcmayi.com/reset/base.min.2015.1123',0,1);
        //增加对IE9一下的浏览器HTML5标签支持
        $html5 .= header_script('//cdn.fcmayi.com/lt.ie.9/html5shiv/3.7.3/html5shiv.min','lt IE 9',1);
        $html5 .= header_script('//cdn.fcmayi.com/lt.ie.9/selectivizr/1.0.2/selectivizr-min','lt IE 9',1);

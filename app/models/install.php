...
*/
class Install extends \es\core\Model{
 ...
 */
  private function generate($table){
    ...
    $path = APPPATH."models/{$this->tableName}.php";
    $pkid = '';
$model = <<<PHP
...
PHP;
    ...
    $model = sprintf( $model,ES_VERSION, \es\core\get_format_time(), ucfirst($this->tableName), rtrim($attrs) );
